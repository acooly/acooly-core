...
public class Https {
  ...
  public String statusInfo() {
    ...
    PoolingClientConnectionManager connectionManager =
        (PoolingClientConnectionManager) this.httpclient.getConnectionManager();
    sb.append("{");
  ...
  private ContentType loadContentType(ContentType contentType) {
    ...
    return ContentType.create(
        ContentType.APPLICATION_FORM_URLENCODED.getMimeType(), defaultCharset);
  }
  ...
  public HttpResult get(
      String url, Map<String, String> dataMap, Map<String, String> headerMap, String charset) {
    ...
    if (dataMap != null && !dataMap.isEmpty()) {
      ...
      for (Entry<String, ?> entry : dataMap.entrySet()) {
        if (entry.getValue() != null
          ...
          value =
              enableUrlEncode
                  ? Encodes.urlEncode((String) entry.getValue(), charset)
