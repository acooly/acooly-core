CREATE TABLE `sms_log` (
  ...
  `PROVIDER_STATUS` varchar(32) DEFAULT NULL COMMENT '提供商状态',
  `PROVIDER_MEMO` varchar(128) DEFAULT NULL,
  `STATUS` int(11) NOT NULL COMMENT '状态 {1:未发送,2:发送失败,3:发送成功}',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=40462 DEFAULT CHARSET=utf8 COMMENT='短信发送记录';
