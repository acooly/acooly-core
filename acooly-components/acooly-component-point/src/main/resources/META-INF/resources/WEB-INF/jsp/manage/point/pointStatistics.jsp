...
<div class="easyui-layout" data-options="fit : true,border : false">
      ...
      <table class="tableForm" width="100%">
        <tr>
          <td align="left">
          	...
          	<a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:false" onclick="$.acooly.framework.search('manage_pointStatistics_searchform','manage_pointStatistics_datagrid');"><i class="fa fa-search fa-lg fa-fw fa-col"></i>查询</a>
          	</div>
          </td>
        </tr>
      </table>
  ...
  <div data-options="region:'center',border:false">
    <table id="manage_pointStatistics_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/point/pointStatistics/listJson.html" toolbar="#manage_pointStatistics_toolbar" fit="true" border="false" fitColumns="false"
      ...
      <thead>
        <tr>
			...
			<th field="memo">备注</th>
          	<th field="rowActions" data-options="formatter:function(value, row, index){return formatAction('manage_pointStatistics_action',value,row)}">动作</th>
        </tr>
      </thead>
    </table>
