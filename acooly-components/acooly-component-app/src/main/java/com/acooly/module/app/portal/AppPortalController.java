...
public class AppPortalController extends AbstractStandardEntityController<AppVersion, AppVersionService> {
	...
	@ResponseBody
	public Object download(@PathVariable("appCode") String appCode, @PathVariable("deviceType") String deviceType,
		...
		try {
			...
			doDownloadHeader(
					appVersion.getAppName() + "v" + appVersion.getVersionName() + "."
							+ Files.getFileExtension(file.getName()), response, deviceType);
