...
public class LogbackConfigurator {
    ...
    public LogbackConfigurator(
            LoggerContext context, ClassLoader classLoader, Environment environment) {
     ...
     * @return
     */
    public Appender<ILoggingEvent> asyncFileAppender(
    ...
    public RollingFileAppender<ILoggingEvent> fileAppender(
            String appenderName, String pattern, String fileName) {
