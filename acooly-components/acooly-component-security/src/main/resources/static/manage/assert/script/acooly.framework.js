		...
		framework : {
			...
			kingEditor : function(opts) {
				...
				var options = {
					...
					items : [ 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', 'removeformat', '|', 'justifyleft', 'justifycenter', 'justifyright', 'plainpaste', 'wordpaste', 'insertorderedlist', 'insertunorderedlist', '|', 'emoticons', 'image', 'multiimage',
							'link', 'unlink', 'source', 'preview' ],
					// 上传的url
