...
<div class="easyui-layout" data-options="fit : true,border : false">
  ...
  <div data-options="region:'north',border:false" style="padding:5px; overflow: hidden;" align="left">
    <form id="manage_lotteryUserCount_searchform" onsubmit="return false">
      <table class="tableForm" width="100%">
        <tr>
          <td align="left">
					活动ID:<input type="text" size="15" name="search_EQ_lotteryid" value="${param.search_EQ_lotteryid}"  />
					活动标题:<input type="text" size="15" name="search_LIKE_lotteryTitle" value="${param.search_LIKE_lotteryTitle}"  />
					参与人:<input type="text" size="15" name="search_LIKE_user" value="${param.search_LIKE_user}"  />
					获参次数:<input type="text" size="15" name="search_EQ_totalTimes" value="${param.search_EQ_totalTimes}"  />
					参与次数:<input type="text" size="15" name="search_EQ_playTimes" value="${param.search_EQ_playTimes}"  />
					...
					最后修改时间:<input size="15" id="search_GTE_updateTime" name="search_GTE_updateTime" size="15" onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
  ...
  <div data-options="region:'center',border:false">
    ...
    <div id="manage_lotteryUserCount_action" style="display: none;">
      ...
      <a class="line-action icon-show" onclick="$.acooly.framework.show('/manage/module/lottery/lotteryUserCount/show.html?id={0}',500,400);" href="#" title="查看"></a>
