...
public class LotteryWinner extends AbstractEntity {
     ...
     * 抽奖标题
     */
    @Column(name = "lottery_title", length = 64, nullable = false, columnDefinition = "varchar(64)  not null comment '抽奖标题'")
     ...
     * 中奖人
     */
    @Column(name = "winner", length = 32, nullable = false, columnDefinition = "varchar(32)  not null comment '中奖人'")
