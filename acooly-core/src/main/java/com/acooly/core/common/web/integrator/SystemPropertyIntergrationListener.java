 ...
 *
 * <p>目前处理：1、spring.profiles.active ,2.webapp.root
 *
 * <p>迁移到:com.acooly.core.integration
 *
 * @author zhangpu
 */
@Deprecated
public class SystemPropertyIntergrationListener implements ServletContextListener {
  ...
  private void setSpringProfileActiveSystemProperty(ServletContext servletContext) {
    ...
    if (StringUtils.isNotBlank(profile)) {
      servletContext.log(
          "Use System property " + SPRING_PROFILE_ACTIVE_KEY_PARAM + " = " + profile);
      return;
    }
    ...
    servletContext.log("Use context-param " + SPRING_PROFILE_ACTIVE_KEY_PARAM + " = " + profile);
  }
