    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="manage_pointAccount_toolbar">
            ...
            <a href="#" class="easyui-linkbutton" plain="true"
               onclick="$.acooly.framework.create({url:'/manage/point/pointAccount/grant.html',entity:'pointAccount',width:500,height:400,addButton:'积分发放',reload:true})"><i
                    class="fa fa-plus-circle fa-lg fa-location-arrow fa-col"></i>积分发放</a>
            <a href="#" class="easyui-linkbutton" plain="true"
