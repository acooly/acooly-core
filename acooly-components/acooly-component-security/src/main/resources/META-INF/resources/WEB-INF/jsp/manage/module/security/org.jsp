...
<div class="easyui-layout" data-options="fit : true,border : false">
    ...
    <div data-options="region:'center',border:false">
        <table id="manage_org_datagrid" class="easyui-treegrid"
               url="${pageContext.request.contextPath}/manage/module/security/org/listTree.html" toolbar="#manage_org_toolbar"  fit="true" border="false" fitColumns="true"
...
--%>
        ...
        <div id="manage_org_action" style="display: none;">
            <a onclick="$.acooly.framework.create({url:'/manage/module/security/org/create.html?parentId={0}',entity:'org',width:500,height:500,reload:true});" href="#" title="添加"><i class="fa fa-plus-circle fa-lg fa-fw fa-col"></i></a>
            <a onclick="$.acooly.framework.edit({url:'/manage/module/security/org/edit.html',id:'{0}',entity:'org',width:500,height:500,reload:true});" href="#" title="编辑"><i class="fa fa-pencil fa-lg fa-fw fa-col"></i></a>
            <a onclick="$.acooly.framework.show('/manage/module/security/org/show.html?id={0}',500,500);" href="#" title="查看"><i class="fa fa-file-o fa-lg fa-fw fa-col"></i></a>
        ...
        <div id="manage_org_toolbar">
            <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.create({url:'/manage/module/security/org/create.html?parentId=0',entity:'org',width:500,height:500})"><i class="fa fa-plus-circle fa-lg fa-fw fa-col"></i>添加</a>
        </div>
    </div>
