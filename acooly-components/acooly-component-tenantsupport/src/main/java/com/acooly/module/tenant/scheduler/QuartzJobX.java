 ...
 */
@Component
public class QuartzJobX implements Job {
    ...
    private static final Logger logger = LoggerFactory.getLogger(
            com.acooly.module.scheduler.job.QuartzJob.class);
    @Autowired
    ...
    public void execute( JobExecutionContext context ) {
        ...
        try {
            String tenantId = (String) context.getScheduler().getContext()
                    .get(TenantContext.TENANT_ID);
            if (!StringUtils.isEmpty(tenantId)) {
                TenantContext.set(tenantId);
                MDC.put("tid", tenantId);
            }
        } catch (SchedulerException e) {
            logger.error("get tenantId error.", e);
        }
        ...
        try {
            ...
            schedulerRule =
                    objectMapper.readValue((String) dataMap.get(SCHEDULER_RULE_DO_KEY),
                            SchedulerRule.class);
            ...
            TaskExecutor taskExecutor =
                    TaskExecutorProvider
                            .get(TaskTypeEnum.getEnumByCode(schedulerRule.getActionType()));
            ...
            schedulerRuleRepository
                    .updateExceptionAtLastExecute(msgAtLastExecute, schedulerRule.getId());
            MDC.clear();
        }
    }
