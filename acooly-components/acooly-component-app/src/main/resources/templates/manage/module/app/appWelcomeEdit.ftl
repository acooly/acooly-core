...
<div>
    <form id="manage_appWelcome_editform" action="/manage/module/app/appWelcome/<#if action == 'create'>save<#else>update</#if>Json.html" method="post" enctype="multipart/form-data">
