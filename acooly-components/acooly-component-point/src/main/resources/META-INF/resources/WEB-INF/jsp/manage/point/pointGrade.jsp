...
<div class="easyui-layout" data-options="fit : true,border : false">
    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="manage_pointGrade_action" style="display: none;">
            <a onclick="$.acooly.framework.edit({url:'/manage/point/pointGrade/edit.html',id:'{0}',entity:'pointGrade',width:500,height:400});"
        ...
        <div id="manage_pointGrade_toolbar">
            <a href="#" class="easyui-linkbutton" plain="true"
               onclick="$.acooly.framework.create({url:'/manage/point/pointGrade/create.html',entity:'pointGrade',width:500,height:400})"><i
