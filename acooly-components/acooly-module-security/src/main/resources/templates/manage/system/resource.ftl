...
<div class="easyui-layout" data-options="fit : true,border : false">
  <div data-options="region:'north'" style="overflow: hidden; height:30px;padding-left: 2px;">
    <div id="manage_resource_toolbar" style="margin-top: 1px;">
      <a href="#" class="easyui-linkbutton" plain="true" onclick="manage_resource_tree_toggle()"><i class="fa fa-plus-square fa-lg fa-fw fa-col" ></i>展开/收起菜单</a>
      <a href="#" class="easyui-linkbutton" plain="true" onclick="manage_resource_form_add(true)"><i class="fa fa-plus-circle fa-lg fa-fw fa-col" ></i>添加顶级菜单</a>
    </div>
  </div>
  <!-- 菜单树 -->
      ...
      <jodd:form bean="resource" scope="request">
        ...
        <table class="tableForm" width="100%">
          <tr>
            ...
            <td><div id="manage_resource_node_parentName"></div>
          ...
          <tr>
            <th>资源类型：</th>
            <td>
                <select name="type" editable="false"  panelHeight="auto" style="width: 150px;" class="easyui-combobox" data-options="required:true">
                    <#list allTypes.keySet() as key><option value="${key}">${allTypes.get(key)}</option></#list>
                </select>
            </td>
          </tr>  
           <tr>
            ...
            <td>
                <select id="manage_resource_form_showState" name="showState" style="width: 150px;" editable="false"  panelHeight="auto" class="easyui-combobox" data-options="required:true">
                   <#list allShowStates.keySet() as key><option value="${key}">${allShowStates.get(key)}</option></#list>
                </select>
            </td>
          </tr>         
          <tr>
