...
<div class="easyui-layout" data-options="fit : true,border : false">
      ...
      <table class="tableForm" width="100%">
        <tr>
          <td align="left">
            ...
            操作结果:<select name="search_EQ_operateResult" editable="false" style="width:80px;height:27px;" panelHeight="auto" class="easyui-combobox"><option value="">所有</option>
          <#list allOperateResults as k,v><option value="${k}">${v}</option></#list>
          </select>
            操作时间:<input id="search_GTE_operateTime" class="text name="search_GTE_operateTime" size="10" onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" />
            至<input id="search_LTE_operateTime" class="text name="search_LTE_operateTime" size="10" onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" />
  ...
  <div data-options="region:'center',border:false">
    <table id="manage_olog_datagrid" class="easyui-datagrid" url="/manage/component/olog/olog/listJson.html" toolbar="" fit="true" border="false" fitColumns="true"
      pagination="true" idField="id" pageSize="20" pageList="[ 10, 20, 30, 40, 50 ]" sortName="id" sortOrder="desc" checkOnSelect="true" selectOnCheck="true" nowrap="false">
      <thead>
        <tr>
			<th field="id">ID</th>
    ...
    <div id="manage_olog_action" style="display: none;">
      <a class="line-action icon-show" title="详情" onclick="$.acooly.framework.show('/manage/component/olog/olog/show.html?id={0}',700,500);" href="#"></a>
    </div>
