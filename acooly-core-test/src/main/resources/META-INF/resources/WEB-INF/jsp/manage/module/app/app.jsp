...
<div class="easyui-layout" data-options="fit : true,border : false">
  ...
  <div data-options="region:'center',border:false">
    <table id="manage_app_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/module/app/app/listJson.html" toolbar="#manage_app_toolbar" fit="true" border="false" fitColumns="false"
    ...
    <div id="manage_app_action" style="display: none;">
      <a onclick="$.acooly.framework.edit({url:'/manage/module/app/app/edit.html',id:'{0}',entity:'app',width:500,height:400});" href="#" title="编辑"><i class="fa fa-pencil fa-lg fa-fw fa-col"></i></a>
      <a onclick="$.acooly.framework.show('/manage/module/app/app/show.html?id={0}',500,400);" href="#" title="查看"><i class="fa fa-file-o fa-lg fa-fw fa-col"></i></a>
      <a onclick="$.acooly.framework.remove('/manage/module/app/app/deleteJson.html','{0}','manage_app_datagrid');" href="#" title="删除"><i class="fa fa-trash-o fa-lg fa-fw fa-col"></i></a>
    </div>
    
    <!-- 表格的工具栏 -->
    <div id="manage_app_toolbar">
      <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.create({url:'/manage/module/app/app/create.html',entity:'app',width:500,height:400})"><i class="fa fa-plus-circle fa-lg fa-fw fa-col"></i>添加</a> 
      <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.removes('/manage/module/app/app/deleteJson.html','manage_app_datagrid')"><i class="fa fa-trash-o fa-lg fa-fw fa-col"></i>批量删除</a>
      ...
      <div id="manage_app_exports_menu" style="width:150px;">
        <div onclick="$.acooly.framework.exports('/manage/module/app/app/exportXls.html','manage_app_searchform','app')"><i class="fa fa-file-excel-o fa-lg fa-fw fa-col"></i>Excel</div>  
        <div onclick="$.acooly.framework.exports('/manage/module/app/app/exportCsv.html','manage_app_searchform','app')"><i class="fa fa-file-text-o fa-lg fa-fw fa-col"></i>CSV</div> 
      </div>
      <a href="#" class="easyui-linkbutton" plain="true" onclick="$.acooly.framework.imports({url:'/manage/module/app/app/importView.html',uploader:'manage_app_import_uploader_file'});"><i class="fa fa-arrow-circle-o-up fa-lg fa-fw fa-col"></i>批量导入</a> 
    </div>
  </div>
