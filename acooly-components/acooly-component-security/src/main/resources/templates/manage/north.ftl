		...
		<div class="header">
			...
			<div class="header-right">
				...
				<div style="float: right;">
					<a href="javascript:;" onclick="$.acooly.framework.changePassword();" class="easyui-linkbutton" style="width: 80px; height: 24px;" data-options="iconCls:'icon-password'">修改密码</a> <a href="javascript:;" onclick="$.acooly.framework.logout();" class="easyui-linkbutton" style="width: 60px; height: 24px;" data-options="iconCls:'icon-logout',width:'80'">注销</a>
				</div>
			</div>
		</div>
		<div id="mainMenu" class="nav"></div>
		<div style="position: absolute; right: 0px; bottom: 0px;">
			<a href="javascript:void(0);" class="easyui-menubutton" data-options="menu:'#layout_menu_theme',iconCls:'icon-theme'" style="color: #fefefe;">主题 (theme)</a>
		</div>
