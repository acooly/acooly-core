...
public class ItemMetadata implements Comparable<ItemMetadata> {
    ...
    ItemMetadata(
            ItemMetadata.ItemType itemType,
            String prefix,
            String name,
            String type,
            String sourceType,
    ...
    public static ItemMetadata newGroup(
            String name, String type, String sourceType, String sourceMethod) {
        return new ItemMetadata(
                ItemMetadata.ItemType.GROUP, name, null, type, sourceType, sourceMethod, null, null, null);
    }

    public static ItemMetadata newProperty(
            String prefix,
            String name,
            String type,
            String sourceType,
