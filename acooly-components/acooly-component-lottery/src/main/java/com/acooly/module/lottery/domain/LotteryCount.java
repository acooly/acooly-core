 ...
 */
@Entity
@Table(name = "lottery_count", indexes = {@Index(columnList = "ukey", name = "UK_L_COUNT_UKEY", unique = true),
...
public class LotteryCount extends AbstractEntity {
     ...
     * 关键字
     */
    @Column(name = "ukey", length = 64, nullable = false, columnDefinition = "varchar(64)  not null comment '关键字'")
    private String ukey;
    /**
     * 计数值
     */
     ...
     * 备注
     */
    @Column(name = "comments", length = 128, nullable = true, columnDefinition = "varchar(128) null comment '备注'")
