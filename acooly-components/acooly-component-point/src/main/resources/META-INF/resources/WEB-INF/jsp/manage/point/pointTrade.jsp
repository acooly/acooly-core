...
<div class="easyui-layout" data-options="fit : true,border : false">
  ...
  <div data-options="region:'center',border:false">
    <table id="manage_pointTrade_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/point/pointTrade/listJson.html" toolbar="#manage_pointTrade_toolbar" fit="true" border="false" fitColumns="false"
      ...
      <thead>
        <tr>
			...
			<th field="tradeType" data-options="formatter:function(value){ return formatRefrence('manage_pointTrade_datagrid','allTradeTypes',value);} ">交易类型</th>
			...
			<th field="businessData">相关业务数据</th>
		    <th field="createTime" formatter="formatDate">创建时间</th>
		    <th field="updateTime" formatter="formatDate">修改时间</th>
			<th field="memo">备注</th>
          	<th field="rowActions" data-options="formatter:function(value, row, index){return formatAction('manage_pointTrade_action',value,row)}">动作</th>
        </tr>
      </thead>
    </table>
...
<!--       <a onclick="$.acooly.framework.edit({url:'/manage/point/pointTrade/edit.html',id:'{0}',entity:'pointTrade',width:500,height:400});" href="#" title="编辑"><i class="fa fa-pencil fa-lg fa-fw fa-col"></i></a> -->
      <a onclick="$.acooly.framework.show('/manage/point/pointTrade/show.html?id={0}',500,400);" href="#" title="查看"><i class="fa fa-file-o fa-lg fa-fw fa-col"></i></a>
