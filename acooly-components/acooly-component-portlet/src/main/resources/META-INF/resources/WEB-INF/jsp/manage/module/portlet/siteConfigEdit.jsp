...
<div>
    <form id="manage_siteConfig_editform" action="${pageContext.request.contextPath}/manage/module/portlet/siteConfig/${action=='create'?'saveJson':'updateJson'}.html" method="post">
      <jodd:form bean="siteConfig" scope="request">
        ...
        <table class="tableForm" width="100%">
			...
			<tr>
				<th>参数值：</th>
				<td><textarea rows="3" cols="40" style="width:300px;" name="value" class="easyui-validatebox"  validType="byteLength[1,4000]"></textarea></td>
			</tr>					
			<tr>
				<th>备注：</th>
