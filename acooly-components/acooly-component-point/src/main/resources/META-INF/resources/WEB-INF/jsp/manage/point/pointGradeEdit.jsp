    ...
    <form id="manage_pointGrade_editform"
        ...
        <jodd:form bean="pointGrade" scope="request">
            ...
            <table class="tableForm" width="100%">
                ...
                <tr>
                    <th>积分区间_开始：</th>
                    <td><input type="text" name="startPoint" size="48" class="easyui-numberbox text" data-options="required:true"
                               validType="byteLength[1,10]"/></td>
                </tr>
                <tr>
                    <th>积分区间_结束：</th>
                    <td><input type="text" name="endPoint" size="48" class="easyui-numberbox text" data-options="required:true"
                               validType="byteLength[1,10]"/></td>
                </tr>
                <!-- 			<tr> -->
                <!-- 				<th> 图标：</th> -->
