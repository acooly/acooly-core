...
<div>
    <form id="manage_org_editform" action="${pageContext.request.contextPath}/manage/module/security/org/${action=='create'?'saveJson':'updateJson'}.html" method="post">
        <jodd:form bean="org" scope="request">
            ...
            <table class="tableForm" width="100%">
                ...
                <tr>
                    <th>机构名称：</th>
                    <td><input type="text" name="name" size="48" class="easyui-validatebox text"  validType="byteLength[1,32]" data-options="required:true"/></td>
                </tr>
                ...
                <tr>
                    <th>省/市/县：</th>
                    <td>
                        <select id="s_province" name="province"></select> <select id="s_city" name="city"></select> <select id="s_county" name="county"></select>
                    </td>
                </tr>
                <tr>
                    <th>手机号：</th>
                ...
                <tr>
                    <th>地址：</th>
                    <td><textarea rows="3" cols="40" style="width:300px;" name="address" class="easyui-validatebox"  validType="byteLength[1,255]"></textarea></td>
                </tr>
                <tr>
                    <th>联系人：</th>
