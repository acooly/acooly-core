    ...
    <form id="manage_appConfig_editform" action="${pageContext.request.contextPath}/manage/module/config/appConfig/${action=='create'?'saveJson':'updateJson'}.html" method="post">
      <jodd:form bean="appConfig" scope="request">
        ...
        <table class="tableForm" width="100%">
			...
			<tr>
				<th>配置值：</th>
				<td><textarea rows="3" cols="40" placeholder="请输入配置值..." style="width:300px;" name="configValue" class="easyui-validatebox" data-options="validType:['length[1,1024]'],required:true"></textarea></td>
			</tr>					
			<tr>
				<th>配置描述：</th>
