 ...
 * @author zhangpu
 */
public class CertNoValidator extends ConstraintValidatorSupport implements ConstraintValidator<CertNo, String> {
	...
	public boolean isValid(String value, ConstraintValidatorContext context) {
		...
		if (!CertNoPredicate.INSTANCE.apply(value)) {
			if (hasCustomMessage()) {
				context.disableDefaultConstraintViolation();
				context.buildConstraintViolationWithTemplate("{com.acooly.utils.validator.CertNo.invalid.message}")
				        .addConstraintViolation();
			}
			return false;
		}
