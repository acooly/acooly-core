...
import com.acooly.core.common.boot.*;
...
public class ExApplicationRunListener implements SpringApplicationRunListener, PriorityOrdered {
	...
	private void initEnvVars(BootApp yijiBootApplication) {
		...
		//for extends log
		System.setProperty(LoggingSystem.SYSTEM_PROPERTY, ExApplicationRunListener.class.getName());
