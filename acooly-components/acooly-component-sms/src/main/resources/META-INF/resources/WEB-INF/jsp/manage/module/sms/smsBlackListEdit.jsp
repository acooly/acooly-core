...
<div>
    <form id="manage_smsBlackList_editform" action="${pageContext.request.contextPath}/manage/module/sms/smsBlackList/${action=='create'?'saveJson':'updateJson'}.html" method="post">
