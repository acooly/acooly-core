...
public class RealNameAuthenticationProxy implements RealNameAuthentication, ApplicationContextAware {
    ...
    public RealNameAuthentication getRealNameAuthentication() {
        if (realNameAuthentication == null) {
            synchronized (object) {
                if (realNameAuthentication == null) {
                    realNameAuthentication = (RealNameAuthentication) this.applicationContext
                        .getBean(certificationProperties.getProvider().code());
                }
            }
        }
