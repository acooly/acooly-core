...
<div class="easyui-layout" data-options="fit : true,border : false">
                ...
                <tr>
                    <td align="left">
                        ...
                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:false"
                           onclick="$.acooly.framework.search('manage_lotteryUserCount_searchform','manage_lotteryUserCount_datagrid');">查询</a>
                    </td>
                </tr>
            </table>
        </form>
    ...
    <div data-options="region:'center',border:false">
        <table id="manage_lotteryUserCount_datagrid" class="easyui-datagrid"
               url="${pageContext.request.contextPath}/manage/module/lottery/lotteryUserCount/listJson.html"
               toolbar="#manage_lotteryUserCount_toolbar" fit="true" border="false" fitColumns="true"
            ...
            <tr>
                ...
                <th field="availTimes" data-options="formatter:function(value,row,index){ return (row.totalTimes - row.playTimes) }">可参与次数
                </th>
        ...
        <div id="manage_lotteryUserCount_action" style="display: none;">
            <a class="line-action icon-edit"
               onclick="$.acooly.framework.edit({url:'/manage/module/lottery/lotteryUserCount/edit.html',id:'{0}',entity:'lotteryUserCount',width:500,height:400});"
               href="#" title="编辑"></a>
            <a class="line-action icon-delete"
               onclick="$.acooly.framework.remove('/manage/module/lottery/lotteryUserCount/deleteJson.html','{0}','manage_lotteryUserCount_datagrid');"
               href="#" title="删除"></a>
        </div>
        ...
        <div id="manage_lotteryUserCount_toolbar">
            ...
            <div id="manage_lotteryUserCount_exports_menu" style="width:150px;">
                <div data-options="iconCls:'icon-excel'"
                     onclick="$.acooly.framework.exports('/manage/module/lottery/lotteryUserCount/exportXls.html','manage_lotteryUserCount_searchform','lottery_user_count')">
                    Excel
                </div>
                <div data-options="iconCls:'icon-csv'"
                     onclick="$.acooly.framework.exports('/manage/module/lottery/lotteryUserCount/exportCsv.html','manage_lotteryUserCount_searchform','lottery_user_count')">
                    CSV
                </div>
            </div>
        </div>
