...
public class JPushAppNotifyServiceImpl implements AppNotifyService {
	...
	@Override
	public void group(NotifyMessage notifyMessage, List<String> targets, String sender, boolean save) {
		try {
			...
			if (save) {
				...
				appMessage.setType(Collections3.isNotEmpty(targets) ? AppMessageType.group : AppMessageType.broadcast);
