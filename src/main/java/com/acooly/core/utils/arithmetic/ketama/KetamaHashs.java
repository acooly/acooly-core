...
public class KetamaHashs {
	...
	private KetamaHashs(String nodeNamePrefix, String nodeNameSplits, Integer nodes, Integer nodeCopies) {
		...
		locator = new KetamaNodeLocator(this.nodeNamePrefix, this.nodes, this.nodeCopies, this.nodeNameSplits);
	}
	...
	public static KetamaHashs INSTANCE(String nodeNamePrefix, String nodeNameSplits, Integer nodes,
			Integer nodeCopies) {
		if (ketamaHashs == null) {
