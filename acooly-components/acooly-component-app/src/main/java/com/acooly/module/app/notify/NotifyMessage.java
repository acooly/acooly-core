 ...
 * context)和JPush:Notification( alert -> content和extras -> context,
 * android:title -> title)</li>
 * <li>如果在properties扩展参数中设置了JPush_Notification参数，则只会发送JPush：Message,
 * notification的消息一扩展设置为准</li>
 * </ul>
 * 
 * @author zhangpu
 * @date 2015年11月4日
