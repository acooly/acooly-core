...
function manage_app_add(){
    $.acooly.framework.create({url:'/manage/module/app/app/create.html',entity:'app',width:500,height:400,hideSaveBtn:true,buttons:[
        {
...
<div class="easyui-layout" data-options="fit : true,border : false">
  ...
  <div data-options="region:'center',border:false">
    ...
    <div id="manage_app_toolbar">
      <a href="#" class="easyui-linkbutton" plain="true" onclick="manage_app_add()"><i class="fa fa-plus-circle fa-lg fa-fw fa-col"></i>添加</a>
