...
public class ContentTypeManagerController extends AbstractJQueryEntityController<ContentType, ContentTypeService> {
    ...
    public JsonListResult<Map<String, Object>> loadTree(
        ...
        JsonListResult<Map<String, Object>> result =
                new JsonListResult<Map<String, Object>>();
        try {
            ...
            if (entities != null) {
                ...
                for (ContentType contentType : entities) {
                    Map<String, Object> row =
                            BeanMapper.deepMap(contentType, properties);
                    row.put("parentId", contentType.getParent() != null
                            ? contentType.getParent().getId() : 0);
                    row.put("state", contentType.getChildren() != null &&
                            contentType.getChildren().size() > 0
                            ? "closed" : "open");
    ...
    protected ContentType onSave(
            ...
            ContentType entity, boolean isCreate)
            throws Exception {
