...
<div>
    <form id="manage_category_editform"
          action="${pageContext.request.contextPath}/manage/store/category/${action=='create'?'saveJson':'updateJson'}.html" method="post">
        <jodd:form bean="category" scope="request">
            <input name="id" type="hidden"/>
            <table class="tableForm" width="100%">
                <tr>
                    <th width="25%">父ID：</th>
                    <td><input type="text" name="parentId" size="48" class="easyui-numberbox text" data-options="required:true"
