...
/**
 * 支持in @Select("select * from City1 where id in #{ids}") List<City1> selectByIn(@Param("ids")
 * List<String> ids);
 *
 * @author qiuboboy@qq.com
 * @date 2018-01-16 18:00
 */
            ...
            for (SqlSegEntry e : sqlCache) {
                ...
                if (e.index >= 0) {
                    ...
                    try {
                        ...
                        return new BoundSql(configuration, this.sql, parameterMappings, parameterObject);
                    }
                    if (obj != null) {
