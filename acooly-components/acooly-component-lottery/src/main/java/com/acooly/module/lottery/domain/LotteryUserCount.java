 ...
 */
@Entity
@Table(name = "lottery_user_count", indexes = {
        @Index(columnList = "lottery_id,user", name = "UK_LOTTERY_USER_COUNT", unique = true)})
public class LotteryUserCount extends AbstractEntity {
     ...
     * 活动标题
     */
    @Column(name = "lottery_title", length = 64, nullable = true, columnDefinition = "varchar(64) comment '标题'")
    private String lotteryTitle;
    /**
     * 参与人
     */
    @Column(name = "user", length = 64, nullable = false, columnDefinition = "varchar(32)  not null comment '参与人'")
    private String user;
    /**
     * 获参次数
     */
