...
public class PortletAutoConfig extends WebMvcConfigurerAdapter {
    ...
    @Bean
    @ConditionalOnProperty(value = PortletProperties.PREFIX + ".actionlog.filterEnable", matchIfMissing = true)
    public Filter portalActionLogFilter(ActionLogService actionLogService) throws Exception {
        ...
        portalActionLogFilter.setFilterUrlPatterns(portletProperties.getActionlog().getFilterUrlPatterns());
        return portalActionLogFilter;
    }

    @Bean
    @ConditionalOnProperty(value = PortletProperties.PREFIX + ".actionlog.filterEnable", matchIfMissing = true)
    public FilterRegistrationBean portalActionLogFilterRegistrationBean(@Qualifier("portalActionLogFilter") Filter portalActionLogFilter) {
