...
public class SmsServiceImpl implements SmsService,InitializingBean {
	...
	@Override
	public void sendByTemplate(String mobileNo, String template, Map<String, Object> data, SmsContext smsContext) {
		String content = null;
		try {
	...
	@Override
	public void sendByTemplateAsync(final String mobileNo, final String template, final Map<String, Object> data) {
	...
	@Override
	public void batchSendByTemplate(List<String> mobileNos, String template, Map<String, Object> data) {
		String content = smsTemplate.getMessage(template, data);
		batchSend(mobileNos, content);
	}

	protected void saveLog(String mobileNo, String content, SmsStatus smsStatus, String result, String resultMessage,
			SmsContext context) {
	...
	protected void saveLogs(List<String> mobileNos, String content, SmsStatus smsStatus, String result,
	...
	protected void sendCheck(String mobileNo, SmsContext context) {
		...
		if (count > 0) {
			throw new ShortMessageSendException("-1002", "手机号码(" + mobileNo + ")发送频率(间隔" + sendInterval + "秒)过大");
		}
	}
