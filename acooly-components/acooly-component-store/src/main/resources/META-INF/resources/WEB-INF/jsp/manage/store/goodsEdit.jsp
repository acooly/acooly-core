...
<div>
    <form id="manage_goods_editform" action="${pageContext.request.contextPath}/manage/store/goods/${action=='create'?'saveJson':'updateJson'}.html" method="post">
      <jodd:form bean="goods" scope="request">
        ...
        <table class="tableForm" width="100%">
			...
			<tr>
				<th>品类ID：</th>
				<td><input type="text" name="categroryId" size="48" class="easyui-numberbox text" data-options="required:true" validType="byteLength[1,19]"/></td>
			</tr>					
			<tr>
				<th>品类名称：</th>
				<td><input type="text" name="categroryName" size="48" class="easyui-validatebox text"  validType="byteLength[1,32]"/></td>
			</tr>					
			<tr>
				<th>商品编码：</th>
			...
			<tr>
				<th>商品简介：</th>
				<td><textarea rows="3" cols="40" style="width:300px;" name="descn" class="easyui-validatebox"  validType="byteLength[1,255]"></textarea></td>
			</tr>					
			<tr>
				<th>单价：</th>
