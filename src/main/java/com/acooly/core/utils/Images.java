...
public class Images {
	...
	public static void main(String[] args) {
		resize("C:\\workspace\\project\\hrhs-docs\\design\\ui\\style\\华尔恒生.png", "d:\\temp\\4.jpg", 200, 200, false);
	}
	...
	public static void pressText(String pressText, String targetImg, String fontName, int fontStyle, Color color,
			int fontSize, int x, int y, float alpha, Integer degree) {
		try {
			...
			g.drawString(pressText, (width - (getLength(pressText) * fontSize)) / 2 + x, (height - fontSize + y));
			g.dispose();
