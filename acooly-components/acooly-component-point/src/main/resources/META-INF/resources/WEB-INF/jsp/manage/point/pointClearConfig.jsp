...
<div class="easyui-layout" data-options="fit : true,border : false">
    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="manage_pointClearConfig_action" style="display: none;">
            <a onclick="$.acooly.framework.confirmSubmit('/manage/point/pointClearConfig/pointClear.html','{0}','manage_pointClearConfig_datagrid','积分清零','此操作影响用户积分,请再次确认是否执行《积分清零》?');"
               href="#" title="积分清零"><i class="fa fa-history fa-lg fa-fw fa-col"></i></a>
