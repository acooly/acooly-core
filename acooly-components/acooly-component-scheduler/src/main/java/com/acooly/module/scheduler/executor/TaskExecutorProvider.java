...
public class TaskExecutorProvider implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        Map<String, TaskExecutor> beansMap = ApplicationContextHolder.get().getBeansOfType(TaskExecutor.class);
        ...
        beansMap.values().forEach(
            task -> {
                ...
                if (taskMap.containsKey(taskTypeEnum)) {
                    String msg = taskTypeEnum + "已经注册," + "已注册的执行器:"
