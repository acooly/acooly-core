...
public class CertificationServiceImpl implements CertificationService {
    ...
    public CertResult certification(String realName, String idCardNo) {
        ...
        try {
            CertificationRecord certificationRecord = certificationRecordService.findEntityByCarNoAndRealName(idCardNo, realName);
    ...
    protected void saveRecord(CertResult result, CertificationRecord certificationRecord) {
        ...
        certificationRecord.setStatus(StringUtils.equals(result.getResultCode(), ResultStatus.success.getCode()) ? 1 : 0);
