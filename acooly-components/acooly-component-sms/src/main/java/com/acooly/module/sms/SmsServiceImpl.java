...
public class SmsServiceImpl implements SmsService, InitializingBean {
  ...
  @Resource private ShortMessageSender shortMessageSender;
  @Resource private SmsTemplate smsTemplate;
  @Resource private SmsLogService smsLogService;
  @Resource private SmsBlacklistService smsBlacklistService;
