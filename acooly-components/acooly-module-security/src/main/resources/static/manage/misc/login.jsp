...
<!-- bootstrap -->
<link rel="stylesheet" href="/manage/plugin/bootstrap/3.3.5/css/bootstrap.min.css">
<link rel="stylesheet" href="/manage/plugin/bootstrap/3.3.5/css/bootstrap-theme.min.css">
<link rel="stylesheet" href="/manage/plugin/awesome/4.6.3/css/font-awesome.min.css">
<link rel="stylesheet" href="/manage/style/login.css">
...
<body>
        ...
        <div class="inner-bg">
            <div class="container">
                ...
                <div class="row">
                   ...
                   <input type="hidden" id="_csrf" name="_csrf" value="${requestScope['org.springframework.security.web.csrf.CsrfToken'].token}" />
	...
	<script type="text/javascript" src="/manage/plugin/jquery/jquery-1.9.1.min.js"></script>
	<script type="text/javascript" src="/manage/plugin/bootstrap/3.3.5/js/bootstrap.min.js"></script>
