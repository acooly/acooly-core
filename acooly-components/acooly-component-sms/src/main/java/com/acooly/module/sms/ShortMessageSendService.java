...
public interface ShortMessageSendService {
	 ...
	 * @param mobileNo
	 * @param template
	 *            模板key(sms.properties中的模板段，如：sms.template.activate)
	 * @param data
	 *            模板数据
	 */
	 ...
	 * @param smsContext
	 */
	void sendByTemplate(String mobileNo, String template, Map<String, Object> data, SmsContext smsContext);
	 ...
	 *            发送会话，会写入发送日志
	 */
	void sendByTemplateAsync(String mobileNo, String template, Map<String, Object> data, SmsContext smsContext);
	 ...
	 * @param mobileNos
	 * @param template
	 *            模板名称（sms.properties中的模板段，如：sms.template.activate）
	 * @param data
	 */
