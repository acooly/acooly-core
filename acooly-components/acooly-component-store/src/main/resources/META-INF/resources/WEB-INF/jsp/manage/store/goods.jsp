...
<div class="easyui-layout" data-options="fit : true,border : false">
                    ...
                    <td align="left">
                        <div>
                            ...
                            <a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:false"
                               onclick="$.acooly.framework.search('manage_goods_searchform','manage_goods_datagrid');"><i
    ...
    <div data-options="region:'center',border:false">
        <table id="manage_goods_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/store/goods/listJson.html"
               toolbar="#manage_goods_toolbar" fit="true" border="false" fitColumns="false"
            ...
            <tr>
                ...
                <th field="rowActions"
                    data-options="formatter:function(value, row, index){return formatAction('manage_goods_action',value,row)}">动作
                </th>
            </tr>
            </thead>
        </table>
        ...
        <div id="manage_goods_action" style="display: none;">
            <a onclick="$.acooly.framework.edit({url:'/manage/store/goods/edit.html',id:'{0}',entity:'goods',width:500,height:400});"
               href="#" title="编辑"><i class="fa fa-pencil fa-lg fa-fw fa-col"></i></a>
            <a onclick="$.acooly.framework.show('/manage/store/goods/show.html?id={0}',500,400);" href="#" title="查看"><i
                    class="fa fa-file-o fa-lg fa-fw fa-col"></i></a>
            <a onclick="$.acooly.framework.remove('/manage/store/goods/deleteJson.html','{0}','manage_goods_datagrid');" href="#"
        ...
        <div id="manage_goods_toolbar">
            <a href="#" class="easyui-linkbutton" plain="true"
               onclick="$.acooly.framework.create({url:'/manage/store/goods/create.html',entity:'goods',width:500,height:400})"><i
                    class="fa fa-plus-circle fa-lg fa-fw fa-col"></i>添加</a>
            <a href="#" class="easyui-linkbutton" plain="true"
               onclick="$.acooly.framework.removes('/manage/store/goods/deleteJson.html','manage_goods_datagrid')"><i
                    class="fa fa-trash-o fa-lg fa-fw fa-col"></i>批量删除</a>
            <a href="#" class="easyui-menubutton" data-options="menu:'#manage_goods_exports_menu'"><i
                    class="fa fa-arrow-circle-o-down fa-lg fa-fw fa-col"></i>批量导出</a>
            <div id="manage_goods_exports_menu" style="width:150px;">
                <div onclick="$.acooly.framework.exports('/manage/store/goods/exportXls.html','manage_goods_searchform','商品信息')"><i
                        class="fa fa-file-excel-o fa-lg fa-fw fa-col"></i>Excel
                </div>
                <div onclick="$.acooly.framework.exports('/manage/store/goods/exportCsv.html','manage_goods_searchform','商品信息')"><i
                        class="fa fa-file-text-o fa-lg fa-fw fa-col"></i>CSV
                </div>
            </div>
            <a href="#" class="easyui-linkbutton" plain="true"
               onclick="$.acooly.framework.imports({url:'/manage/store/goods/importView.html',uploader:'manage_goods_import_uploader_file'});"><i
