				...
				<div align="center" style="margin-top: 10px;">
					<form id="loginForm" method="post">
						...
						<table class="tableForm" width="100%" style="margin-bottom: 20px">
							...
							<tr>
								<th>密&nbsp;&nbsp;码</th>
								<td><input type="password" id="password" name="password" class="easyui-validatebox" data-options="required:true" style="width: 150px; height: 25px; padding-left: 2px;" /></td>
							</tr>
							<tr id="captchaPanel" style="display: none;">
								<th>验证码</th>
								<td><img id="jcaptchaImage" onclick="refreshCaptcha()" src="/jcaptcha.jpg" height="30px" width="70px" align="top"> <input type="text" id="captcha" name="captcha" class="easyui-validatebox" data-options="required:false" style="width: 73px; height: 25px; padding-left: 2px;" /></td>
							</tr>
						</table>
					</form>
				</div>
