...
<div class="easyui-layout" data-options="fit : true,border : false">
      ...
      <table class="tableForm" width="100%">
        <tr>
          <td align="left">
          	...
          	<a href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:false" onclick="$.acooly.framework.search('manage_certificationRecord_searchform','manage_certificationRecord_datagrid');"><i class="fa fa-search fa-lg fa-fw fa-col"></i>查询</a>
          	</div>
          </td>
        </tr>
      </table>
  ...
  <div data-options="region:'center',border:false">
    <table id="manage_certificationRecord_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/module/certification/certificationRecord/listJson.html" toolbar="#manage_certificationRecord_toolbar" fit="true" border="false" fitColumns="false"
      ...
      <thead>
        <tr>
			...
			<th field="status" data-options="formatter:function(value){ return formatRefrence('manage_certificationRecord_datagrid','allStatuss',value);} ">状态</th>
