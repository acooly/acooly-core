...
<div class="easyui-layout" data-options="fit : true,border : false">
  ...
  <div data-options="region:'north',border:false" style="padding:5px; overflow: hidden;" align="left">
    <form id="manage_feedback_searchform" onsubmit="return false">
      <table class="tableForm" width="100%">
        <tr>
          <td align="left">
					类型:<select style="width:80px;height:27px;" name="search_EQ_type" editable="false" panelHeight="auto" class="easyui-combobox" >
					...
					日期:<input size="15" class="text" id="search_GTE_createTime" name="search_GTE_createTime" size="15" onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
					至<input size="15" class="text" id="search_LTE_createTime" name="search_LTE_createTime" size="15" onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
  ...
  <div data-options="region:'center',border:false">
    <table id="manage_feedback_datagrid" class="easyui-datagrid" url="${pageContext.request.contextPath}/manage/module/portlet/feedback/listJson.html" toolbar="#manage_feedback_toolbar" fit="true" border="false" fitColumns="true"
      ...
      <thead>
        <tr>
			...
			<th field="id">id</th>
			<th field="type" data-options="formatter:function(value){ return formatRefrence('manage_feedback_datagrid','allTypes',value);} ">类型</th>
            ...
            <th field="status" data-options="formatter:function(value){ return formatRefrence('manage_feedback_datagrid','allStatuss',value);} ">状态</th>
    ...
    <div id="manage_feedback_action" style="display: none;">
      <a onclick="$.acooly.framework.edit({url:'/manage/module/portlet/feedback/edit.html',id:'{0}',entity:'feedback',width:500,height:400});" href="#" title="处理"><i class="fa fa-pencil fa-lg fa-fw fa-col"></i></a>
      <a onclick="$.acooly.framework.show('/manage/module/portlet/feedback/show.html?id={0}',500,400);" href="#" title="查看"><i class="fa fa-file-o fa-lg fa-fw fa-col"></i></a>
    </div>
