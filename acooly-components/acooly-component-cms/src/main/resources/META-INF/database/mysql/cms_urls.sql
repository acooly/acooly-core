INSERT INTO `sys_resource` (`ID`, `PARENTID`, `NAME`, `TYPE`, `SHOW_STATE`, `ORDER_TIME`, `VALUE`, `SHOW_MODE`, `ICON`, `DESCN`) VALUES ('20151024', NULL, '组件:CMS', 'MENU', '0', '2015-10-23 18:32:05', '', '1', 'icons-resource-caozuorizhichaxun', NULL);
