 ...
 * 条形码工具类
 * 
 * 1、二维码采用QRcode 2、一维条形码采用CODE_128
 * 
 * @author zhangpu
 * 
 */
...
//		System.out.println("条形码解码完成：" + decodeContent);
	...
	public static void encodeQRcode(String content, String encoding, Integer size, OutputStream output,
	...
	public static void encodeBarcode(String str, Integer width, Integer height, OutputStream output,
			boolean closeAfterComplete) {
		try {
