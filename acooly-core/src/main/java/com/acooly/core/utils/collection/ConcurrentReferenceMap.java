...
import com.acooly.core.utils.collection.ref.FinalizablePhantomReference;
import com.acooly.core.utils.collection.ref.FinalizableReference;
import com.acooly.core.utils.collection.ref.FinalizableReferenceQueue;
import com.acooly.core.utils.collection.ref.FinalizableSoftReference;
import com.acooly.core.utils.collection.ref.FinalizableWeakReference;
 ...
 * <p>
 * 引用类型请参考 {@link java.lang.ref}与 {@link com.yjf.common.ref} 的描述。
 * <p>
...
public class ConcurrentReferenceMap<K, V> extends AbstractMap<K, V>
	...
	private V getValue(Object valueReference) {
		return (V) (this.valueReferenceType == ReferenceValueType.STRONG ? valueReference
				: valueReference == null ? null : ((Reference<V>) valueReference).get());
	}

	@SuppressWarnings("unchecked")
	private K getKey(Object keyReference) {
		return (K) (this.keyReferenceType == ReferenceKeyType.STRONG ? keyReference
		...
		return new AbstractSet<Entry<K, V>>() {
			...
			public Iterator<Entry<K, V>> iterator() {
				return new Iterator<Entry<K, V>>() {
					private Iterator<Entry<Object, Object>> iterator = ConcurrentReferenceMap.this.map.entrySet()
							.iterator();
