...
public class OrgManagerController extends AbstractJQueryEntityController<Org, OrgService> {
    ...
    @Override
    protected Org onSave(HttpServletRequest request, HttpServletResponse response, Model model, Org entity,
    ...
    @Override
    public JsonEntityResult<Org> updateJson(HttpServletRequest request, HttpServletResponse response) {
